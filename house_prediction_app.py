...
bath = st.number_input('Number of Bathrooms', min_value=0,max_value=10)
bhk = st.number_input('BHK Value', min_value=0,max_value=10)
...
if st.button('Predict Price'):
    ...
    # Calling prediction pipeline to predict the outputpip install scikit-learn==0.24.2
